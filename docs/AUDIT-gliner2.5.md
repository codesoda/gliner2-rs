...
| Every milestone records | `PROGRESS-gliner2.5.md`: done/measured/next/questions; descriptive git commit; Astra review | Phase A, M0–M4 and direct ORT migration documented/committed/pushed. M5 final review/gates accepted and ready for its scoped commit; later gates pending |
